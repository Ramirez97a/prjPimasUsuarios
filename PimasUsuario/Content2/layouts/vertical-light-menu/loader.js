    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: false,
                logo: {
                    darkLogo: '~/Content2/src/assets/img/logo.svg',
                    lightLogo: '~/Content2/src/assets/img/logo.svg'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '~/Content2/src/assets/img/logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
